<template>
  <div v-if="config && config.fields" class="list-items">
    ...
    <div v-if="!isMobile" class="cards-grid">
      <a v-for="item in paginatedItems" :key="item.uuid" :href="getItemLink(item)" target="_blank" rel="noopener noreferrer" class="aspect-card card">
        <div class="meta">
      ...
      <div v-if="hasMoreItems" class="aspect-card load-more" @click="loadMore">
        <div class="content">
          <div class="icon"></div>
      ...
      <div class="carousel-wrapper">
        ...
        <div class="carousel-track" ref="carouselRef" @touchstart="handleTouchStart" @touchmove="handleTouchMove" @touchend="handleTouchEnd">
          ...
          <div v-if="hasMoreItems" class="carousel-slide" :class="{ center: currentIndex === paginatedItems.length }">
            <div class="aspect-card load-more" @click="loadMore">
              <div class="content">
                <div class="icon"></div>
                <div class="text">{{ translate('ui', 'Загрузить ещё') }}</div>
                <div class="count">{{ remaining }} {{ translate('ui', 'осталось') }}</div>
