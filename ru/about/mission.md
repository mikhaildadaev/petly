...
blocks:
  - name: Мы верим, что каждый питомец заслуживает дом, а каждый человек может стать частью доброго дела.
  ...
  - name: ... Наши ценности
    list:
      - point: Доброта
        ...
        info: В основе всего — любовь к животным и желание помочь.

      - point: Единство
        image: /assets/webp/value-unity.webp
        info: Вместе мы сильнее. Каждый волонтёр — часть большой команды.
    
      - point: Открытость
        image: /assets/webp/value-openness.webp
        info: Мы честны с волонтёрами и прозрачны в своих действиях.
    type: steps

  - name: ... Наши цели
    list:
      - point: Помогать животным
        image: /assets/webp/mission-help.webp
        info: Мы верим, что каждый питомец заслуживает любящую семью и заботу.

      - point: Объединять людей
