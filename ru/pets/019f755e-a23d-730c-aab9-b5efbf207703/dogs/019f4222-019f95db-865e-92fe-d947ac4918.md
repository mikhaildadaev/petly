---
uuid: '019f4222-019f95db-865e-92fe-d947ac4918'
title: 'Нора 12'
...
# Питомец
<div class="uuid">019f4222-019f95db-865e-92fe-d947ac4918</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Нора 12 — Спокойный и послушный. Хорошо подходит для пожилых людей.
...
Нора 12 — это замечательный питомец, который ищет свой дом. Он попал в приют в 20.10.2023. Сейчас ему нужна любящая семья.
