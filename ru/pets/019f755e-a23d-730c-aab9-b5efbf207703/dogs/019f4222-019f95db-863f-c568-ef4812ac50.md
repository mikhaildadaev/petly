---
uuid: '019f4222-019f95db-863f-c568-ef4812ac50'
title: 'Соня 4'
...
# Питомец
<div class="uuid">019f4222-019f95db-863f-c568-ef4812ac50</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Соня 4 — Душа компании. Очень дружелюбный и активный питомец.
...
Соня 4 — это замечательный питомец, который ищет свой дом. Он попал в приют в 22.07.2023. Сейчас ему нужна любящая семья.
