---
uuid: '019f4222-019f95db-85d1-58e1-d8d70176f8'
title: 'Нора 92'
...
# Питомец
<div class="uuid">019f4222-019f95db-85d1-58e1-d8d70176f8</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Нора 92 — Душа компании. Очень дружелюбный и активный питомец.
...
Нора 92 — это замечательный питомец, который ищет свой дом. Он попал в приют в 05.03.2025. Сейчас ему нужна любящая семья.
