---
uuid: '019f4222-019f95db-5da2-4870-a064be36e0'
title: 'Соня 64'
...
# Питомец
<div class="uuid">019f4222-019f95db-5da2-4870-a064be36e0</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Соня 64 — Спокойный и послушный. Хорошо подходит для пожилых людей.
...
Соня 64 — это замечательный питомец, который ищет свой дом. Он попал в приют в 18.03.2026. Сейчас ему нужна любящая семья.
