---
uuid: '019f4222-019f95db-85fa-ec11-b227612b68'
title: 'Тайсон 12'
...
# Питомец
<div class="uuid">019f4222-019f95db-85fa-ec11-b227612b68</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Тайсон 12 — Спокойный и послушный. Хорошо подходит для пожилых людей.
...
Тайсон 12 — это замечательный питомец, который ищет свой дом. Он попал в приют в 16.12.2023. Сейчас ему нужна любящая семья.

> «Каждый питомец заслуживает дом, а каждый человек может стать частью доброго дела.»

Если вы ищете верного друга — Тайсон 12 станет отличным выбором!
