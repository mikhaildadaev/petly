---
uuid: '019f4222-019f95db-92bf-84b7-7d88bcdf70'
title: 'Дружок 13'
...
# Питомец
<div class="uuid">019f4222-019f95db-92bf-84b7-7d88bcdf70</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Дружок 13 — Самостоятельный и умный. Быстро учится новым командам.
...
Дружок 13 — это замечательный питомец, который ищет свой дом. Он попал в приют в 03.07.2023. Сейчас ему нужна любящая семья.
