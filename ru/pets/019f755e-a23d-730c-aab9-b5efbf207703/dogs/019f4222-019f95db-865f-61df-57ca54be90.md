---
uuid: '019f4222-019f95db-865f-61df-57ca54be90'
title: 'Герда 21'
...
# Питомец
<div class="uuid">019f4222-019f95db-865f-61df-57ca54be90</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Герда 21 — Самостоятельный и умный. Быстро учится новым командам.
...
Герда 21 — это замечательный питомец, который ищет свой дом. Он попал в приют в 17.11.2024. Сейчас ему нужна любящая семья.
