---
uuid: '019f4222-019f95db-9359-fd81-0f7f2fbf98'
title: 'Соня 83'
...
# Питомец
<div class="uuid">019f4222-019f95db-9359-fd81-0f7f2fbf98</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Соня 83 — Душа компании. Очень дружелюбный и активный питомец.
...
Соня 83 — это замечательный питомец, который ищет свой дом. Он попал в приют в 01.04.2022. Сейчас ему нужна любящая семья.
