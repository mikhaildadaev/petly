---
uuid: '019f4222-019f95db-862d-dd13-e46597a6e0'
title: 'Герда 86'
...
# Питомец
<div class="uuid">019f4222-019f95db-862d-dd13-e46597a6e0</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Герда 86 — Душа компании. Очень дружелюбный и активный питомец.
...
Герда 86 — это замечательный питомец, который ищет свой дом. Он попал в приют в 04.01.2024. Сейчас ему нужна любящая семья.
