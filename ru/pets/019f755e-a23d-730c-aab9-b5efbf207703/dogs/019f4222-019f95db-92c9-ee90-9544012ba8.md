---
uuid: '019f4222-019f95db-92c9-ee90-9544012ba8'
title: 'Нора 1'
...
# Питомец
<div class="uuid">019f4222-019f95db-92c9-ee90-9544012ba8</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Нора 1 — Душа компании. Очень дружелюбный и активный питомец.
...
Нора 1 — это замечательный питомец, который ищет свой дом. Он попал в приют в 16.08.2023. Сейчас ему нужна любящая семья.
