---
uuid: '019f4222-019f95db-144a-a91c-e31e711aa8'
title: 'Соня 0'
...
# Питомец
<div class="uuid">019f4222-019f95db-144a-a91c-e31e711aa8</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Соня 0 — Игривый и весёлый. Отлично ладит с детьми и другими животными.
...
Соня 0 — это замечательный питомец, который ищет свой дом. Он попал в приют в 22.11.2021. Сейчас ему нужна любящая семья.
