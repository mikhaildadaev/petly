---
uuid: '019f4222-019f95db-861b-3b56-ff97b864c8'
title: 'Герда 84'
...
# Питомец
<div class="uuid">019f4222-019f95db-861b-3b56-ff97b864c8</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Герда 84 — Душа компании. Очень дружелюбный и активный питомец.
...
Герда 84 — это замечательный питомец, который ищет свой дом. Он попал в приют в 30.03.2025. Сейчас ему нужна любящая семья.
