---
uuid: '019f4222-019f95db-932c-35f7-2e8e18b6e0'
title: 'Белка 93'
...
# Питомец
<div class="uuid">019f4222-019f95db-932c-35f7-2e8e18b6e0</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Белка 93 — Душа компании. Очень дружелюбный и активный питомец.
...
Белка 93 — это замечательный питомец, который ищет свой дом. Он попал в приют в 13.06.2023. Сейчас ему нужна любящая семья.
