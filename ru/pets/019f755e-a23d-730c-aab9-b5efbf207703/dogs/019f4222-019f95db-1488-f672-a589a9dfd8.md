---
uuid: '019f4222-019f95db-1488-f672-a589a9dfd8'
title: 'Дружок 43'
...
# Питомец
<div class="uuid">019f4222-019f95db-1488-f672-a589a9dfd8</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Дружок 43 — Спокойный и послушный. Хорошо подходит для пожилых людей.
...
Дружок 43 — это замечательный питомец, который ищет свой дом. Он попал в приют в 19.11.2025. Сейчас ему нужна любящая семья.
