---
uuid: '019f4222-019f95db-9317-cc33-c413a5c050'
title: 'Граф 24'
...
# Питомец
<div class="uuid">019f4222-019f95db-9317-cc33-c413a5c050</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Граф 24 — Спокойный и послушный. Хорошо подходит для пожилых людей.
...
Граф 24 — это замечательный питомец, который ищет свой дом. Он попал в приют в 22.08.2023. Сейчас ему нужна любящая семья.
