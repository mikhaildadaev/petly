---
uuid: '019f4222-019f95db-5da3-93d3-f54096e710'
title: 'Дружок 69'
...
# Питомец
<div class="uuid">019f4222-019f95db-5da3-93d3-f54096e710</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Дружок 69 — Самостоятельный и умный. Быстро учится новым командам.
...
Дружок 69 — это замечательный питомец, который ищет свой дом. Он попал в приют в 11.01.2023. Сейчас ему нужна любящая семья.
