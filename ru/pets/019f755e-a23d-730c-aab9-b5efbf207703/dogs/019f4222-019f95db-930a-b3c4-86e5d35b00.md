---
uuid: '019f4222-019f95db-930a-b3c4-86e5d35b00'
title: 'Лада 80'
...
# Питомец
<div class="uuid">019f4222-019f95db-930a-b3c4-86e5d35b00</div>
<CardPetHero :type="'dogs'"/>

## Характер

- **Особенности:** Лада 80 — Спокойный и послушный. Хорошо подходит для пожилых людей.
...
Лада 80 — это замечательный питомец, который ищет свой дом. Он попал в приют в 05.12.2024. Сейчас ему нужна любящая семья.
